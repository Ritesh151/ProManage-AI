  ...
  useEffect(() => {
    if (project) {
      ...
      setFormData({
        ...
        hasGoogleBusinessProfile: project.hasGoogleBusinessProfile || false,
        hasClientDomain: project.hasClientDomain || false,
        hasClientLogo: project.hasClientLogo || false,
        hasClientContent: project.hasClientContent || false,
